...
- [flux-cluster-config](https://github.com/QuantumDancer/flux-cluster-config): Flux CD based deployments for the Talos Linux cluster. Deprecated. Configuration is currently moved to ArgoCD based Platform Apps repo.
